...
async function registerUser(name, email, password, password_confirm) {
    try {
        ...
        await queryAsync('INSERT INTO user_profile (description, nick, profilePhoto, full_name,age,phone,address,userID,games_library,games_downloaded) VALUES  (?, ?, ?, ?, ?, ?, ?, ?,0 ,0)', [basic_description, name, basic_photo,basic_name,basic_age, basic_phone, basic_address,user_ID[0].userID]);
